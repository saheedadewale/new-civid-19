const covid19ImpactEstimator = (data) => {
  ...
  impact.dollarsInFlight = (impactD * data.region.avgDailyIncomeInUSD) * data.timeToElapse;
  severeImpact.dollarsInFlight = (severeD * data.region.avgDailyIncomeInUSD) * data.timeToElapse;
  return {
    data,
    impact,
    severeImpact
